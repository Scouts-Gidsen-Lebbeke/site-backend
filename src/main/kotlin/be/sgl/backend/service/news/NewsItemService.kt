package be.sgl.backend.service.news
...
import be.sgl.backend.repository.news.NewsItemRepository
import be.sgl.backend.exception.NewsItemNotFoundException
import be.sgl.backend.mapper.news.NewsItemMapper
